...
public class tp2 extends javax.swing.JFrame {
    ...
    public void judul() {
        // judul untuk tabel
        Object[] judul = { "No", "Merk", "Plat", "Warna", "Jenis" };
        tabModel = new DefaultTableModel(null, judul);
        jTable1.setModel(tabModel);
    }

    public void tampilData(String where) {
//        prosedur untuk menampilkan data yang ada di db
        try {
            ...
            while (rs.next()) {
                Object[] data = { rs.getString("id"), rs.getString("merk"), rs.getString("plat"),
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Nama : Mochamad Mufid Abiyyu");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        //jika ada yang kosong langsung return
        ...
        try {
            st = cn.createStatement();
            st.executeUpdate(
                    "INSERT INTO data_mobil(id, merk, plat, warna, jenis) VALUES(NULL,'" + tMerk.getText() + "','" + tPlat.getText() + "','" + tWarna.getText() + "','" + jComboBox1.getSelectedItem().toString() + "')");
